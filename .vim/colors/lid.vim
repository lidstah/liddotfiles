...
hi CursorColumn                           ctermbg=8 guibg=#444444
hi CursorLine                             ctermbg=8 guibg=#3a3a3a cterm=none gui=none
hi Error        ctermfg=4  guifg=#ffffff ctermbg=1   guibg=#800000
hi ErrorMsg     ctermfg=4  guifg=#ffffff ctermbg=1   guibg=#800000
...
hi SpecialKey   ctermfg=4  guifg=#5fdf5f
...
hi StatusLine   ctermfg=4  guifg=#ffffff ctermbg=4 guibg=#4e4e4e cterm=bold gui=bold
hi StatusLineNC ctermfg=249 guifg=#b2b2b2 ctermbg=8 guibg=#3a3a3a cterm=none gui=none
hi TabLine      ctermfg=252  ctermbg=8 guibg=#666666 cterm=none gui=none
...
hi Constant     ctermfg=5 guifg=#ffffaf
hi Identifier   ctermfg=4 guifg=#dfafdf                           cterm=bold
hi Ignore       ctermfg=7 guifg=#444444
hi Number       ctermfg=6 guifg=#dfaf87
hi PreProc      ctermfg=2 guifg=#afdf87
hi Special      ctermfg=6 guifg=#df8787 			    cterm=bold
hi Statement    ctermfg=6 guifg=#87afdf                           cterm=bold gui=none
hi Type         ctermfg=5 guifg=#afafdf

"" Special {{{2
""" .diff {{{3
hi diffAdded    ctermfg=40 guifg=#afdf87
...
hi treeOpenable   ctermfg=40  guifg=#afdf87
