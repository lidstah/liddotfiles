...
hi Conditional             guifg=#BF9F5F cterm=bold
...
hi Function                guifg=#877C43 cterm=bold
hi Identifier              guifg=#BF9F5F cterm=bold
hi IncSearch               guibg=#FF5FFF guifg=#262626
hi Keyword                 guifg=#1C678C gui=none cterm=bold
...
hi Title                   guifg=#808080 cterm=bold
hi Todo                    guifg=#5BA65A guibg=#1A1A1A gui=bold
hi Typedef                 guifg=#993535 cterm=bold
