...
if g:lucius_style == "dark"
    ...
    hi Normal       guifg=#d7d7d7   guibg=#303030   ctermfg=188    ctermbg=0       gui=none      cterm=none
    ...
    hi TabLine      guifg=bg        guibg=#b2b2b2   ctermfg=bg     ctermbg=238       gui=none      cterm=none
    hi TabLineFill  guifg=#444444   guibg=#b2b2b2   ctermfg=238    ctermbg=238       gui=none      cterm=none
    hi TabLineSel   guifg=fg        guibg=#005f87   ctermfg=fg     ctermbg=24        gui=bold      cterm=bold
    hi VertSplit    guifg=#626262   guibg=#b2b2b2   ctermfg=241    ctermbg=238       gui=none      cterm=none
    ...
    hi LineNr       guifg=#626262   guibg=#444444   ctermfg=241    ctermbg=0       gui=none      cterm=none
    hi CursorLineNr guifg=#626262   guibg=#444444   ctermfg=241    ctermbg=0       gui=none      cterm=none
