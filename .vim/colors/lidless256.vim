...
hi StatusLine   ctermfg=7  guifg=#ffffff ctermbg=239 guibg=#4e4e4e cterm=bold gui=bold
...
hi Todo         ctermfg=0   guifg=#000000 ctermbg=6 guibg=#dfdf00
